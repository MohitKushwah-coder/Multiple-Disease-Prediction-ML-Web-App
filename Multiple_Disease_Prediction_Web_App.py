...
diabtetes_model = pickle.load(open('D:/ML Project/Multiple Disease Prediction/Models/trained_model_diabetes.sav', 'rb'))

heart_model = pickle.load(open('D:/ML Project/Multiple Disease Prediction/Models/trained_model_heart.sav', 'rb'))

brain_model = pickle.load(open('D:/ML Project/Multiple Disease Prediction/Models/trained_model_brain_stroke.sav', 'rb'))
